...
public class ApplicationController {
	...
	public @ResponseBody Map<String,String> config() {
		...
		params.put("adminName", applicationService.getAdminName());
		params.put("adminEmail", applicationService.getAdminEmail());
		params.put("adminPass", applicationService.getAdminPass());
